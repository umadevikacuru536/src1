                    ...
                    <div class="card shadow logincard1 " style={{borderradius: "20px"}}>
                        ...
                        <div class="">
                            ...
                            <input type="text" class="control w-75" style={{padding: "10px"}}
                                ...
                                <p style={{color: "#2c0264"}}>You will recevie an Password on this number</p>
                        </div>
                     <Link to="/sub">   <a href="./submit.html" style={{color: "white"}}> <button class="loginbutton" style={{margintop: "20px"}}>Submit</button></a></Link>
