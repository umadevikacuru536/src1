            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="card shadow logincard1 " style={{borderradius: "20px"}}>
                        ...
                        <input type="password" name="" id="" class="logininput" placeholder="enter your password"/> 
                     <a href="./submit.html" style={{color: "white"}}><p class="loginforgot"style={{marginLeft:"300px",marginLeft:"20px"}}> Enter password that received on your phone number</p></a>
